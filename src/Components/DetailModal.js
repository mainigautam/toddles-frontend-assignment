      ...
      <div className="detail-modal">
        ...
        <div className="modal-col">
          ...
          <div className="modal-col-input">
            <input defaultValue={modalData.heading} type="text" onChange={(e)=>{setHeading(e.target.value)}} className="input-box"/>
          </div>
        </div>
        <div className="modal-col">
          <div className="modal-col-head">Degree</div>
          <div className="modal-col-input">
            <input defaultValue={modalData.subheading} type="text" onChange={(e)=>{setSubheading(e.target.value)}} className="input-box" />
          </div>
        </div>
        <div className="modal-row">
          <div className="modal-col m-right">
            ...
            <div className="modal-col-input">
              <input defaultValue={modalData.start_date} type="text" onChange={(e)=>{setStartDate(e.target.value)}} className="input-box"/>
            </div>
            </div>
            <div className="modal-col">
            <div className="modal-col-head">End Date</div>
            <div className="modal-col-input">
              <input defaultValue={modalData.end_date} type="text" onChange={(e)=>{setEndDate(e.target.value)}} className="input-box"/>
            </div>
          </div>
        </div>
        <div className="modal-col">
          ...
          <div className="modal-col-input">
            <textarea  defaultValue={modalData.desc} onChange={(e)=>{setDescription(e.target.value)}} className="text-area input-box wd-100"></textarea>
          </div>
        </div>
        <div className="modal-row">
